...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-8 col-md-8 col-sm-8">
            <h5 class="card-title">Laptop's Paradise - Selected Item</h5>
            <hr id="hr" />
            <h6 class="card-subtitle mb-2 text-muted">Selected Product to update</h6>
            <form action="?controlador=Items&accion=updateItem" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <input type="text" class="form-control" id="item_name" name="item_name" placeholder="Name" value="<?php echo $vars['item_name'] ?>">
                </div>
                <div class="form-group">
                    <input type="number" class="form-control" id="price" name="price" placeholder="Price" value="<?php echo $vars['price'] ?>">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" id="description" name="description" placeholder="Description" value="<?php echo $vars['description'] ?>">
                </div>
